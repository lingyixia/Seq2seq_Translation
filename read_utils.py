...
class Preprocess():
    ...
    def clears(self, ):
        # 数据清洗
        data_en = 'data/train.tags.data.en'
        data_zh = 'data/train.tags.data.zh'
        data_en_clear = 'data/train.tags.data.en_clear'
        data_zh_clear = 'data/train.tags.data.zh_clear'
...
if __name__ == '__main__':
    ...
    et = TextConverter(text=a, save_dir='model/en_vocab.pkl', max_vocab=10000, seq_length=50)
    zt = TextConverter(text=b, save_dir='model/zh_vocab.pkl', max_vocab=4000, seq_length=50)
    # print(et.vocab)
    # print(zt.vocab)
    print(et.vocab_size)
    print(zt.vocab_size)
